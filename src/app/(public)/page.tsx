...
export default function HomePage() {
  ...
  const rolePortals = [
    ...
    {
      label: "Inspector",
      description: "Residents, maintenance, complaints, visitors, notices, and reports",
    ...
    {
      label: "Admin",
      description: "Blocks, flats, billing setup, users, and society configuration",
      meta: "Build the apartment",
